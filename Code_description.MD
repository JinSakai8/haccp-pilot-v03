...
- **File Picker**: `file_picker` is used for selecting files on Web (replacing `image_picker` or direct camera access), ensuring cross-platform compatibility for logo uploads and waste photos.
