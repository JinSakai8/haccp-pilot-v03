...
5. **Przestarzała Składnia Supabase Filters:**
    - **Błąd:** `The method 'in_' isn't defined`.
    - **Powód:** Zmiana API w `supabase_flutter`.
    - **Rozwiązanie:** Zastąpienie `.in_('col', list)` przez `.filter('col', 'in', list)`.
