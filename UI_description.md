...
Zmiany UX/UI:
- Wdro�ono styl "Premium/Luxury" odpowiadaj�cy marce fine-dining "Mi�so i Piana".
- Zamieniono jednolite t�o na fotograficzne (premium food) z ciemnym, u�ytecznym gradientem, zwi�kszaj�c wra�enie ekskluzywno�ci zachowuj�c przy tym pe�n� czytelno��.
- Klawiatura numeryczna (HaccpNumPad) otrzyma�a wariant isPremiumGlass z efektem Glassmorphism (lekki blur t�a, p�przezroczyste kraw�dzie, brak cienia rzucanego).
- Od�wie�ono typografi� nag��wka, u�ywamy z�oto-miedzianego akcentu koloru (#D4AF37) na ikonie i nazwie lokalu.
- Zast�piono ikon� tarczy na bardziej autorsk� ikon� sztu�c�w restauracyjnych (estaurant_menu).
- Zachowano pe�n� zgodno�� z wymogami "glove-friendly" (przyciski numeryczne min. 80x80 dp) oraz niezmieniono kodu weryfikacji PIN (backend zostaje ten sam).
